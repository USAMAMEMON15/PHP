            ...
            if(!empty($name) && !empty($email) && !empty($image)){
                ...
                $result = $conn->query($sql);
                 if(isset($FILES)){
                  ...
                  $email_type = $_FILES['image']['type'];
                  $email_size = $_FILES['image']['size'];
                  $number_tpm = $_FILES['image']['tmp_name'];
                  
                  move_uploaded_file($_file_tmp , "upload/" .$file_name); 
                }
                ...
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                      <label for="">image</label>
                        <input type="file" name="password" class="form-control" id="">
                    </div>
                    <div class="mb-3">
